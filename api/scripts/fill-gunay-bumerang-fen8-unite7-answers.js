...
const UNITE_NAME = '7. Ünite - Elektrik Yükleri ve Elektrik Enerjisi'

// Fotoğraftan birebir aktarıldı (8 satır: Kavratan 1-4, Bumerang 1-2, Beceri Temelli 1-2).
const TESTS = [
  ['Kavratan Test-1', 'BCADBDCAC'],
  ['Kavratan Test-2', 'DABCBDC'],
  ['Bumerang Test-1', 'DACB'],
  ['Kavratan Test-3', 'ADCBDBCA'],
  ['Kavratan Test-4', 'CADBDAB'],
  ['Bumerang Test-2', 'CCBDA'],
  ['Beceri Temelli Test-1', 'DCBAABDC'],
  ['Beceri Temelli Test-2', 'ABCDDACDD'],
]
