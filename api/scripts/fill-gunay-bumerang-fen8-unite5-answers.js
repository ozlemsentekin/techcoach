...
// Fotoğraftan birebir aktarıldı (10 satır: Kavratan 1-4, Bumerang 1-4, Beceri Temelli 1-2).
const TESTS = [
  ['Kavratan Test-1', 'ADCBCACDBA'],
  ['Bumerang Test-1', 'BADC'],
  ['Kavratan Test-2', 'DCADBDACBA'],
  ['Bumerang Test-2', 'ABDC'],
  ['Kavratan Test-3', 'BACDBCDAAB'],
  ['Bumerang Test-3', 'ADCB'],
  ['Kavratan Test-4', 'DACBDBACBAC'],
  ['Bumerang Test-4', 'BDAC'],
  ['Beceri Temelli Test-1', 'DACBDACB'],
  ['Beceri Temelli Test-2', 'CADDCBDA'],
]
