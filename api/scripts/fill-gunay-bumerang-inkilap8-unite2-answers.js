...
// 2. Ünite - Milli Uyanış: Bağımsızlık Yolunda Atılan Adımlar testlerinin cevap anahtarını
...
const TOPIC_NAME = '2. Ünite - Milli Uyanış: Bağımsızlık Yolunda Atılan Adımlar'

const ANSWER_KEYS = {
  'Kavratan Testler-1': 'CCCBADBB',
  'Kavratan Testler-2': 'CACABBCCC',
  'Kavratan Testler-3': 'ABBBDCDCD',
  'Kavratan Testler-4': 'DCAABADDC',
  'Kavratan Testler-5': 'BACADBDA',
  'Bumerang Testler-1': 'BBCACDBDBB',
  'Beceri Testleri-1': 'DBCBBADB',
  'Beceri Testleri-2': 'BCCDBDCBCC',
}
