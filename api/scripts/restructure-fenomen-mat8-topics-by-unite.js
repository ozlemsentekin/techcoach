...
// Groups fine-grained topics into the same Ünite structure used by
// Hız Yayınları's "8. Sınıf Matematik Soru Bankası" (in book order).
// No group is created for "6. Ünite - Dönüşüm Geometrisi ve Geometrik Cisimler"
// because this book currently has no content for it.
const UNITE_GROUPS = [
  {
  ...
  },
  {
    ...
    topics: ['Olasılık', 'Cebirsel İfadeler ve Özdeşlikler'],
  },
  {
    unite: '4. Ünite - Doğrusal Denklemler ve Eşitsizlikler',
    topics: ['Doğrusal Denklemler Eşitsizlikler', 'Koordinat Sistemi ve Doğrusal İlişki', 'Eğim', 'Eşitsizlikler'],
  },
  {
    unite: '5. Ünite - Üçgenler, Eşlik ve Benzerlik',
    topics: ['Açı Kenar Bağıntıları'],
  },
]
