...
// 7. Ünite - Atatürk'ün Ölümü ve Sonrası testlerinin cevap anahtarını
// kullanıcının gönderdiği fotoğraflardan birebir girer. Kitabın son ünitesi.
const fs = require('fs')
...
const TOPIC_NAME = "7. Ünite - Atatürk'ün Ölümü ve Sonrası"

const ANSWER_KEYS = {
  'Kavratan Testler-1': 'DDCABDCD',
  'Kavratan Testler-2': 'AADCCDDD',
  'Bumerang Testler-1': 'CDAADD',
  'Beceri Testleri-1': 'BDDBBBCA',
}
