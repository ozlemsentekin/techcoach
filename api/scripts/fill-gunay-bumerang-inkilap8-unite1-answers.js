...
// 1. Ünite - Bir Kahraman Doğuyor testlerinin cevap anahtarını kullanıcının gönderdiği
// fotoğraflardan birebir girer.
const fs = require('fs')
...
const TOPIC_NAME = '1. Ünite - Bir Kahraman Doğuyor'

const ANSWER_KEYS = {
  'Kavratan Testler-1': 'BBDABDBC',
  'Kavratan Testler-2': 'DDBADABC',
  'Kavratan Testler-3': 'BDBCCCDC',
  'Kavratan Testler-4': 'BBCBDDA',
  'Kavratan Testler-5': 'CABDDBD',
  'Kavratan Testler-6': 'CBABABBDBC',
  'Bumerang Testler-1': 'CDBCDDAC',
  'Beceri Testleri-1': 'DDCBCD',
  'Beceri Testleri-2': 'BADCCB',
}
