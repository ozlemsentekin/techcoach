...
function schoolMenuItems({ school, onEdit, onDetail, onToggleActive }) {
  return [
    { label: 'Detay', onClick: () => onDetail(school) },
...
export default function AdminSchoolsPage() {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {detailSchool ? (
        <SchoolProfileModal school={detailSchool} onClose={() => setDetailSchool(null)} />
      ) : null}
    </div>
  )
}
